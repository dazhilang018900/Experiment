...
function setTime()
{
	...
	document.getElementById("updatemonth1").value = myDate.getMonth();    //获取月份
	...
	document.getElementById("updatemonth2").value = myDate.getMonth();    //获取月份
	...
	document.getElementById("linhc_content").value = "最爱萌萌驰";   
