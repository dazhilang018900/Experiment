...
public class UserController extends MultiActionController {
    ...
    public ModelAndView setPwd(HttpServletRequest request,
        HttpServletResponse response) throws Exception {
    	...
    	try{
    		...
    		if(us.getPassword().equalsIgnoreCase(pwd)){
    ...
    public ModelAndView listFriend(HttpServletRequest request,
    	...
    	int id=Integer.parseInt(idStr);
		 	...
		 	Instances.getXStream().alias("user",User.class);
		 	return Utils.strView("result",
	 			"<result>succeed</result>"+
				""+Instances.getXStream().toXML(userList)+"");
    }
    ...
    public ModelAndView getUser(HttpServletRequest request,
		...
		try{
			User u=userService.getUserByUsername(username);
		 	Instances.getXStream().alias("user",User.class);
			return Utils.strView("result",
				"<result>succeed</result>"+Instances.getXStream().toXML(u)+"");
		}catch(Exception e){
			return Utils.strView("result",
				"<result>failed</result>");
			}
    ...
    public ModelAndView changePwd(HttpServletRequest request,
    	...
    	System.out.println("saveUser#new pwd"+newPwd);
    	ServletOutputStream out = response.getOutputStream();
    	response.setContentType("text/plain");
    	...
    	try{
    		...
    		String str=us.getPassword();
    		//System.out.println(oldPwd+":"+str);
    		if(str==null||!str.equals(oldPwd)){
    			out.print("check:password not right");
    			return null;
    		}
	        us.setPassword(newPwd);
	        userService.saveUser(us);
    	}catch(UserNotFoundException eee){  
    		out.print("check:exception");
			return null;
    	}   	
    	out.print("check:success");
    	return null;
