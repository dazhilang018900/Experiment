...
public class UserServiceImpl implements UserService {
    ...
    public void addSubscribe(Long userId,String appName){
    	subscribeDao.addSubscribe(userId , appName);
    }
    ...
    public void delSubscribes(Long userId){
    	subscribeDao.delSubscribes(userId);
    }
    
    public void setSubscribe(Long userId, List<Subscribe> subs){
    	subscribeDao.setUserSubscribes(userId, subs);
    }
	...
	public void logLogin(String userName) {
		// TODO Auto-generated method stub
		userDao.logAction(userName, 1);
	}
	public void logLogout(String userName) {
		// TODO Auto-generated method stub
		userDao.logAction(userName, 2);
	}
}
